...
gui.add(material.uniforms.uShadowRepetitions,'value').min(1).max(230).step(1).name('shadow repetition')
...
gui.add(material.uniforms.uLightRepetitions,'value').min(1).max(230).step(1).name('light repetition')
